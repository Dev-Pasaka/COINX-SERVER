...
class GetAllCryptoPrices {
    suspend fun getAllCryptoMetadata(): List<online.pasaka.domain.model.wallet.crypto.Cryptocurrency> {
        ...
        val top10CryptoPrices = mutableListOf<online.pasaka.domain.model.wallet.crypto.Cryptocurrency>()
        ...
        for (data in cryptoData){
            ...
            top10CryptoPrices.add(
                online.pasaka.domain.model.wallet.crypto.Cryptocurrency(
