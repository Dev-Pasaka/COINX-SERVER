...
fun merchantTransferredFundsTemplate(
    title:String = "Funds Transferred",
            ...
            <table align="center" width="100%" style="max-width: 600px; padding: 20px; border: 1px solid #e0e0e0;">
                ...
                <tr>
                    <td align="center" bgcolor="#ffffff" style="padding: 20px;">
                        ...
                        <p>Merchant has transferred funds to your respective account. Kindly confirm and release the crypto assets</p>
