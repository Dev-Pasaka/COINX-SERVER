...
import online.pasaka.domain.model.merchant.wallet.MerchantFloatTopUpMessage
...
suspend fun merchantTopUpProducer(
    ...
    launch {
        ...
        val merchantTopUp = online.pasaka.domain.model.merchant.wallet.MerchantFloatTopUpMessage(
            email = email,
            crypto = message,
        )
